...
CREATE TABLE IF NOT EXISTS `Apps` (
  ...
  `Name` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'SteamDB Unknown App',
  `StoreName` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `LastKnownName` varchar(1000) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `AppsHistory` (
  ...
  `Diff` longtext CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `AppID` (`AppID`)
...
CREATE TABLE IF NOT EXISTS `Depots` (
  ...
  `Name` varchar(1000) CHARACTER SET utf8 NOT NULL DEFAULT 'SteamDB Unknown Depot',
...
CREATE TABLE IF NOT EXISTS `KeyNames` (
  ...
  `DisplayName` varchar(120) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Name` (`Name`),
  KEY `Type` (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `KeyNamesSubs` (
  ...
  `Type` tinyint(1) unsigned NOT NULL DEFAULT 0,
  `Name` varchar(90) COLLATE utf8_bin NOT NULL,
  `DisplayName` varchar(90) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Name` (`Name`),
  KEY `Type` (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `Subs` (
  `SubID` int(7) unsigned NOT NULL,
  `Name` varchar(150) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'SteamDB Unknown Package',
...
ALTER TABLE `Apps` ADD FULLTEXT KEY `Name` (`Name`,`StoreName`,`LastKnownName`);

ALTER TABLE `Subs` ADD FULLTEXT KEY `Name` (`Name`,`StoreName`,`LastKnownName`);
